...
export default function Modal({ opciones, name, position, Icon }) {
    ...
    return (
        <>
            <li onClick={toggleModal} className='flex flex-row items-center gap-2 px-4 py-3 hover:bg-alt-dark rounded-lg hover:text-white cursor-pointer'><Icon size={20} />{name}<FaChevronDown size={12} className="ml-2" /></li>
